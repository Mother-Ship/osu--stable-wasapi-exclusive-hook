...
- 启动后~~需要在游戏内拉-25ms的全局Offset。为什么是这个值我也不知道，我从McOsu的WASAPI独占抄的，据[他们](https://github.com/McKay42/McOsu/blob/master/src/App/Osu/Osu.cpp#L241)说是因为WASAPI独占会使用新版本的bass相关dll，行为和旧版不一样~~不需要拉offset，mcosu拉offset是因为新版bass的播放位置和解码位置不一样，这个hook应该已经处理了这个问题
